...
project = u'xbob.io.video'
import time
copyright = u'%s, Idiap Research Institute' % time.strftime('%Y')

# Grab the setup entry
distribution = pkg_resources.require('xbob.io.video')[0]
...
#html_short_title = 'xbob.io.video'
...
htmlhelp_basename = 'xbob.io.video_doc'
...
latex_documents = [
  ('index', 'xbob.io.video.tex', u'Video I/O Support for Bob',
...
man_pages = [
    ('index', 'xbob.io.video', u'Video I/O Support for Bob',
